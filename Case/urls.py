...
urlpatterns = [
    ...
    path('case_status_notes', views.notes_by_case_and_contact, name="notes_by_case_and_contact"),


    # CONTACT URLS
    # htmx 
    path('contact/<int:case_id>', views.x_contact_div_original, name="x_contact_div_original"),
